...
export const updateRequestStatusForModerator = createAsyncThunk(
  "request/updateRequestStatusForModerator",
  async (
    { requestId, requestStatus }: { requestId: string; requestStatus: string },
    { dispatch }
  ) => {
    let timer;
    try {
