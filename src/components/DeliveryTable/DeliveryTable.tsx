...
import { selectOwnerName } from "../../redux/delivery/deliveryListSelectors";
  ...
  return (
    <Table className={styles.table}>
      ...
      <tbody className={styles.tblContent}>
        {delivery
          .filter((deliveryItem) =>
            ownerName ? deliveryItem.full_name.includes(ownerName) : true
          )
          .map((deliveryItem) => (
            <tr
            ...
            >
              {isAdmin && (
                <td className={styles.td}>{deliveryItem.full_name}</td>
              )}
              {isAdmin && (
              ...
              {/* {isAdmin && (
                <> */}
              <td className={styles.td}>
                {isAdmin && deliveryItem.delivery_status === "в работе" && (
                  <>
                    <Button
                      variant="success"
                      size="sm"
